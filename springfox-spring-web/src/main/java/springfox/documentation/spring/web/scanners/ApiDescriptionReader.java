...
public class ApiDescriptionReader {
  ...
  public List<ApiDescription> read(RequestMappingContext outerContext) {
    RequestCondition patternsCondition = outerContext.getPatternsCondition();
  ...
  private List<String> matchingPaths(ApiSelector selector, RequestCondition patternsCondition) {
